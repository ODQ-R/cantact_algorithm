...
global E, E=10000; % Young’s modulus
...
t_end=5;
[t,y]=ode45('DEMround2Dnorot',[0:0.005:t_end],y0);
...
a=quiver(y(i,1:4:4*n_part),y(i,3:4:4*n_part),y(i,2:4:4*n_part),y(i,4:4:4*n_part));
